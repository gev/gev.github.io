$(function () {
    ...
    var mapi = {
        ...
        a6: {
            ...
            text: 'Проигрывают тв передачи, фильмы, музыку с аудиомультирума',
            my: 'top right',
            adjust: {x: -50, y: 0}
        },
        a7: {
        ...
        reed : {
            style: GREEN_GLOW,
            title: 'Датчик открывания двери',
            text: 'Контролирует открвывание входной двери',
            adjust: {x: -50, y: -350}
        },
        kitchenPuddle : {
            style: OPACITY,
            title: 'Датчик протечки',
            text: 'Автоматически перекроет воду при обнаружении протечки воды',
            adjust: {x: 100, y: 0}
