$(function () {
    ...
    var mapi = {
        ...
        finger: {
            ...
            text: 'При уходе из кватиры запускает сценарий "ухожу из дома", а при возващении домой запускает сценарий "пришел домой"'
        },
        ipad: {
            style: GREEN_GLOW,
    ...
    var mape = {
        ...
        server: {
            style: SCALE,
            title: 'Сервер',
            text: 'Собирает и передает данные панелям управления, упрвляет домашеней мультимедия системой и системой голосового информирования'
        },
        pioneer: {
            style: SCALE,
            title: 'AV ресивер',
