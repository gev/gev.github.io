$(function () {
    ...
    var mape = {
        mikrotik: {
            style: SCALE,
            title: 'Роутер',
            text: 'Подключает умный дом к интернет и обеспечивает удаленное защищенное управление по VPN',
            my: 'top center',
            adjust: {x: -50, y: 0}
        },
        plc: {
        ...
        iphone: {
            style: SCALE,
            title: 'iPhone',
            text: 'Управляет всеми функция и получает голосовые сообщения от умного дома',
            my: 'top center'
        },
        trendent: {
            style: SCALE,
